    ...
    <v-col lg="8" sm="12" xs="12">
      <v-card max-width="800px" flat>
        <p class="display-1 font-weight-bold mb-8">
          What type of water features do you have?
        </p>
        <div class="mt-8">
          <v-checkbox
            v-for="(feature, index) of validFeatures"
            :key="feature.id + index"
            v-model="location.water_features"
            :label="feature.name"
            :value="feature.id"
            hide-details
            color="success"
...
export default {
  ...
  data: () => ({
    validFeatures: [
      ...
      { id: "LAKE", name: "Lake" },
      { id: "POND_STREAM_CREEK", name: "Pond/Stream/Creek" },
      { id: "REFLECTING_POOL", name: "Reflecting Pool" },
